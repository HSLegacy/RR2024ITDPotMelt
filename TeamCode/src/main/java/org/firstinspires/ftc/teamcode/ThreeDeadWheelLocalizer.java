...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1942.2193325522294; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2250.997052190001; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2111.8864609499783; // x position of the perpendicular encoder (in tick units)
    }
